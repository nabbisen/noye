...
/// - Received server banner (220 greeting)
/// - Successful EHLO/HELO exchange
/// - Check whether STARTTLS can be initiated
///
/// Drives the SMTP protocol manually over a TCP socket from the Workers `connect()` API.
...
/// Run each step of the SMTP handshake
async fn smtp_handshake(
    ...
    // Step 1: Receive the banner (220 greeting)
    ...
    // Step 3: Check STARTTLS availability
